...
namespace InfraCodeEditor
{
   public class MyTabPage : System.Windows.Forms.TabPage
    {
       public Principal mainform;
       public MyRichTextBox _myRichTextBox = new MyRichTextBox();

       public MyTabPage(Principal mf)
       {
           mainform = mf;

           this._myRichTextBox.Dock = DockStyle.Fill;
           this._myRichTextBox.richTextBox1.Text = "";
           _myRichTextBox.richTextBox1.Font = new System.Drawing.Font("Courier New", 10, FontStyle.Regular);
       ...
       private void richTextBox1_SelectionChanged(object sender, EventArgs e)
       {
           ...
           mainform.LineToolStripLabel.Text = "Linha : " + line.ToString();
           mainform.ColumnToolStripLabel.Text = "Coluna : " + col.ToString();
       }
